...
pub struct AutoRootBusOffsets {
    ...
    pub soc_offset: u32,
    pub soc_size: u32,
    pub interface_regs_offset: u32,
    pub interface_regs_size: u32,
    pub fifo_regs_offset: u32,
    pub fifo_regs_size: u32,
}
impl Default for AutoRootBusOffsets {
    fn default() -> Self {
        Self {
            ...
            soc_size: 0x5e0,
            interface_regs_offset: 0xa401_0000,
            interface_regs_size: 0x13c,
            fifo_regs_offset: 0xa401_1000,
            fifo_regs_size: 0x1c,
        }
    }
}
pub struct AutoRootBus {
    ...
    pub interface_regs_periph: Option<crate::interface_regs::InterfaceRegsBus>,
    pub fifo_regs_periph: Option<crate::fifo_regs::FifoRegsBus>,
}
impl AutoRootBus {
    ...
    pub fn new(
        ...
        interface_regs_periph: Option<Box<dyn crate::interface_regs::InterfaceRegsPeripheral>>,
        fifo_regs_periph: Option<Box<dyn crate::fifo_regs::FifoRegsPeripheral>>,
    ) -> Self {
        Self {
            delegates,
            ...
            interface_regs_periph: interface_regs_periph
                .map(|p| crate::interface_regs::InterfaceRegsBus { periph: p }),
            fifo_regs_periph: fifo_regs_periph.map(|p| crate::fifo_regs::FifoRegsBus { periph: p }),
        }
    }
}
impl caliptra_emu_bus::Bus for AutoRootBus {
    fn read(
        ...
        if addr >= self.offsets.interface_regs_offset
            && addr < self.offsets.interface_regs_offset + self.offsets.interface_regs_size
        {
            if let Some(periph) = self.interface_regs_periph.as_mut() {
                return periph.read(size, addr - self.offsets.interface_regs_offset);
            }
        }
        if addr >= self.offsets.fifo_regs_offset
            && addr < self.offsets.fifo_regs_offset + self.offsets.fifo_regs_size
        {
            if let Some(periph) = self.fifo_regs_periph.as_mut() {
                return periph.read(size, addr - self.offsets.fifo_regs_offset);
            }
        }
    ...
    fn write(
        ...
        {
            if let Some(periph) = self.interface_regs_periph.as_mut() {
                return periph.write(size, addr - self.offsets.interface_regs_offset, val);
            }
        }
        if addr >= self.offsets.fifo_regs_offset
            && addr < self.offsets.fifo_regs_offset + self.offsets.fifo_regs_size
        {
            if let Some(periph) = self.fifo_regs_periph.as_mut() {
                return periph.write(size, addr - self.offsets.fifo_regs_offset, val);
            }
        }
        for delegate in self.delegates.iter_mut() {
