...
pub trait SocPeripheral {
    ...
    fn write_ss_external_staging_area_base_addr_l(&mut self, _val: caliptra_emu_types::RvData) {}
    fn read_ss_external_staging_area_base_addr_h(&mut self) -> caliptra_emu_types::RvData {
        0
    }
    fn write_ss_external_staging_area_base_addr_h(&mut self, _val: caliptra_emu_types::RvData) {}
    fn read_ss_key_release_base_addr_l(&mut self) -> caliptra_emu_types::RvData {
        0
    }
    fn write_ss_key_release_base_addr_l(&mut self, _val: caliptra_emu_types::RvData) {}
    fn read_ss_key_release_base_addr_h(&mut self) -> caliptra_emu_types::RvData {
        0
    }
    fn write_ss_key_release_base_addr_h(&mut self, _val: caliptra_emu_types::RvData) {}
...
impl caliptra_emu_bus::Bus for SocBus {
    fn read(
        ...
        match addr {
            ...
            0x3a4..0x3c4 => Ok(self.periph.read_fuse_hek_seed((addr as usize - 0x3a4) / 4)),
            ...
            0x538..0x53c => Ok(self.periph.read_ss_external_staging_area_base_addr_l()),
            0x53c..0x540 => Ok(self.periph.read_ss_external_staging_area_base_addr_h()),
            0x540..0x544 => Ok(self.periph.read_ss_key_release_base_addr_l()),
            0x544..0x548 => Ok(self.periph.read_ss_key_release_base_addr_h()),
            0x548..0x54c => Ok(caliptra_emu_types::RvData::from(
                self.periph.read_ss_key_release_size().reg.get(),
            )),
            0x54c..0x550 => Ok(caliptra_emu_types::RvData::from(
                self.periph.read_ss_ocp_lock_ctrl().reg.get(),
            )),
            0x5a0..0x5b0 => Ok(self
                .periph
                .read_ss_strap_generic((addr as usize - 0x5a0) / 4)),
            0x5c0..0x5c4 => Ok(caliptra_emu_types::RvData::from(
                self.periph.read_ss_dbg_service_reg_req().reg.get(),
            )),
            0x5c4..0x5c8 => Ok(caliptra_emu_types::RvData::from(
                self.periph.read_ss_dbg_service_reg_rsp().reg.get(),
            )),
            0x5c8..0x5d0 => Ok(self
                .periph
    ...
    fn write(
        ...
        match addr {
            ...
            0x3a4..0x3c4 => {
                self.periph
                    .write_fuse_hek_seed(val, (addr as usize - 0x3a4) / 4);
                Ok(())
            }
            0x500..0x504 => {
            ...
            0x538..0x53c => {
                self.periph.write_ss_external_staging_area_base_addr_l(val);
                Ok(())
            }
            0x53c..0x540 => {
                self.periph.write_ss_external_staging_area_base_addr_h(val);
                Ok(())
            }
            0x540..0x544 => {
                self.periph.write_ss_key_release_base_addr_l(val);
                Ok(())
            }
            0x544..0x548 => {
                self.periph.write_ss_key_release_base_addr_h(val);
                Ok(())
            }
            0x548..0x54c => {
                self.periph
                    .write_ss_key_release_size(caliptra_emu_bus::ReadWriteRegister::new(val));
                Ok(())
            }
            0x54c..0x550 => {
                self.periph
                    .write_ss_ocp_lock_ctrl(caliptra_emu_bus::ReadWriteRegister::new(val));
                Ok(())
            }
            0x5a0..0x5b0 => {
                self.periph
            ...
            0x5c0..0x5c4 => {
                self.periph
                    .write_ss_dbg_service_reg_req(caliptra_emu_bus::ReadWriteRegister::new(val));
                Ok(())
            }
            0x5c4..0x5c8 => {
                self.periph
                    .write_ss_dbg_service_reg_rsp(caliptra_emu_bus::ReadWriteRegister::new(val));
                Ok(())
            }
            0x5c8..0x5d0 => {
                self.periph
