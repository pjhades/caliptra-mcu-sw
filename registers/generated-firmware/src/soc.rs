    ...
    register_bitfields! {
        u32,
            ...
            pub CptraHwConfig [
                ...
                FuseGranularity OFFSET(1) NUMBITS(1) [],
                RsvdEn OFFSET(2) NUMBITS(2) [],
                LmsAccEn OFFSET(4) NUMBITS(1) [],
                SubsystemModeEn OFFSET(5) NUMBITS(1) [],
                OcpLockModeEn OFFSET(6) NUMBITS(1) [],
            ],
            ...
            pub SsKeyReleaseSize [
                Size OFFSET(0) NUMBITS(16) [],
            ],
            pub SsOcpLockCtrl [
                LockInProgress OFFSET(0) NUMBITS(1) [],
            ],
...
pub mod regs {
    ...
    register_structs! {
        pub Soc {
            ...
            (0x3a4 => pub fuse_hek_seed: [tock_registers::registers::ReadWrite<u32>; 8]),
            (0x3c4 => _reserved4),
            ...
            (0x538 => pub ss_external_staging_area_base_addr_l: tock_registers::registers::ReadWrite<u32>),
            (0x53c => pub ss_external_staging_area_base_addr_h: tock_registers::registers::ReadWrite<u32>),
            (0x540 => pub ss_key_release_base_addr_l: tock_registers::registers::ReadWrite<u32>),
            (0x544 => pub ss_key_release_base_addr_h: tock_registers::registers::ReadWrite<u32>),
            (0x548 => pub ss_key_release_size: tock_registers::registers::ReadWrite<u32, crate::soc::bits::SsKeyReleaseSize::Register>),
            (0x54c => pub ss_ocp_lock_ctrl: tock_registers::registers::ReadWrite<u32, crate::soc::bits::SsOcpLockCtrl::Register>),
            (0x550 => _reserved5),
            (0x5a0 => pub ss_strap_generic: [tock_registers::registers::ReadWrite<u32>; 4]),
            (0x5b0 => _reserved6),
            (0x5c0 => pub ss_dbg_service_reg_req: tock_registers::registers::ReadWrite<u32, crate::soc::bits::SsDbgServiceRegReq::Register>),
            (0x5c4 => pub ss_dbg_service_reg_rsp: tock_registers::registers::ReadWrite<u32, crate::soc::bits::SsDbgServiceRegRsp::Register>),
